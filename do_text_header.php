...
echo ' &nbsp; |';
echo ' &nbsp;<a href="do_test.php?text=' . $textid . '" target="_top"><img src="icn/question-balloon.png" title="Test" alt="Test" /></a>';
echo ' &nbsp;<a href="print_text.php?text=' . $textid . '" target="_top"><img src="icn/printer.png" title="Print" alt="Print" /></a>';
echo get_annotation_link($textid);
echo ' &nbsp;<a target="_top" href="edit_texts.php?chg=' . $textid . '"><img src="icn/document--pencil.png" title="Edit Text" alt="Edit Text" /></a>';
echo ' &nbsp;|';
echo ' &nbsp;<a href="new_word.php?text=' . $textid . '&amp;lang=' . $langid . '" target="ro"><img src="icn/sticky-note--plus.png" title="New Term" alt="New Term" /></a>';
if (isset($infoURI)) 
{
  echo ' &nbsp;|';
  echo ' &nbsp;' . makeOpenInfoLink($infoURI, '<img src="icn/script.png" title="Text Info" alt="Text Info" />');
}
